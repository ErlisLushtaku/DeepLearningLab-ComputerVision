...
def main():
    ...
    extract_evaluate_write_captions(verbose=args.verbose, cpu=True, single_image=args.single_image,
...
def extract_evaluate_write_captions(verbose=False, cpu=True, single_image=False, use_topk_sampling=False, topk=50,
