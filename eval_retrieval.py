...
def main():
    ...
    eval_without_args(verbose=args.verbose, cpu=True, batch_size=args.batch_size, num_workers=args.num_workers,
                      output_dir=args.output_dir, eval_ckpt=args.eval_ckpt)

def eval_without_args(verbose=False, cpu=True, eval_ckpt=None, output_dir="outputs/eval_retrieval", batch_size=16,
                      num_workers=0):
